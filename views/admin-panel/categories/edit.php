...
<div class="container col border-left border-warning table-secondary font-weight-bold mt-3 mb-3 p-3 rounded-lg" style="border-width: 5px!important;">
    ...
    Update Category - <?php echo $editCategory->categoryName; ?>
...
<div class="row justify-content-center mb-5">
    ...
    <div class="col-9">
        ...
        <form action="<?php echo $config['url']['path'] . 'admin-panel/category-update/' . $editCategory->categoryID; ?>" method="POST">

            <div class="form-group">

                <label for="categoryName">Name</label>
                <input type="text" name="categoryName" class="form-control" value="<?php echo $editCategory->categoryName; ?>" required>
